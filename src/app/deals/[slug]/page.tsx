      ...
      <section className="relative mx-[15%] overflow-hidden rounded-2xl bg-blue-600 py-10">
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="mt-6 flex flex-col items-center gap-2 sm:flex-row sm:justify-center">
            <input type="email" placeholder="Email Address" className="w-full max-w-xs rounded-lg border border-zinc-200 bg-white px-4 py-3 text-zinc-900 shadow-sm placeholder:text-zinc-500 focus:border-amber-400 focus:outline-none focus:ring-2 focus:ring-amber-400 sm:max-w-sm" />
            <button type="button" className="flex items-center gap-2 rounded-lg bg-amber-500 px-5 py-3 font-semibold text-white transition hover:bg-amber-600">
