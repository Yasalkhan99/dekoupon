...
/** Recipient for contact/newsletter/coupon emails. Use SMTP_RECIPIENT or default leads@savingshub4u.com (do not use SMTP_USER as recipient). */
const getToEmail = () =>
  process.env.SMTP_RECIPIENT?.trim() || "leads@savingshub4u.com";
